...
namespace TecBurguer.Controllers
{
    ...
    public class IngredientesController : Controller
    {
        ...
        public IngredientesController(DBTecBurguerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdIngrediente,Nome,Quantidade")] Ingrediente ingrediente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdIngrediente,Nome,Quantidade")] Ingrediente ingrediente)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DBTecBurguerContext.Ingredientes'  is null.");
            }
            var ingrediente = await _context.Ingredientes.FindAsync(id);
            if (ingrediente != null)
            {
